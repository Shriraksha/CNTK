    ...
    const std::unordered_map<Variable, Variable>& compositeOutputsMap)
{
    ...
    ONNXIR::NodeArg sumOutputArg(outputName + "_sum_out", nullptr);
    ONNXIR::Node* sumNode = graph->AddNode(outputName + "_sum", "Sum", "", { mulTrueOutputArg, mulFalseOutputArg }, { sumOutputArg });
